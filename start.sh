...
python main.py --chain base --telegram-enabled --scanner-enabled --min-momentum-score-bullish 3.0 --min-momentum-score-bearish 3.0 --min-bullish-profit 1.0 --min-liquidity 400000 --min-volume 50000 --min-txns-h1 3 --interval 15 --token BRETT ZORA VIRTUAL AERO CBBTC WETH AVNT
