...
DAILY_SUMMARY_ENABLED_ENV_VAR = 'DAILY_SUMMARY_ENABLED'
DAILY_SUMMARY_TWEET_ENV_VAR = 'DAILY_SUMMARY_TWEET_ENABLED'
SIGNAL_TWEETS_ENABLED_ENV_VAR = 'SIGNAL_TWEETS_ENABLED'
